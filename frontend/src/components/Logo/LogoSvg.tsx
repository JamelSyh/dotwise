...
const LogoSvg = () => {
  return (
    ...
    >
      <defs>
        <style>
          {`.cls-1, .cls-5 { fill: none; stroke-width: 20px; }
          .cls-1, .cls-3 { stroke: #2bb4ff; }
      ...
      <path className="cls-1" d="M147.86,386.77c0,50,40.3,90.53,90.09,90.53" />
      <path
        className="cls-2"
      ...
      />
      <circle className="cls-3" cx="466.94" cy="319.68" r="33.07" />
      <circle className="cls-3" cx="466.94" cy="411.47" r="33.07" />
      <circle className="cls-3" cx="380.04" cy="411.47" r="33.07" />
      <circle className="cls-3" cx="380.04" cy="503.26" r="33.07" />
      <path
        className="cls-3"
      ...
      />
      <path className="cls-5" d="M491,227.2c0-44.36-40.53-80.26-90.61-80.26" />
    </svg>
  );
};
